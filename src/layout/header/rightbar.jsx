          ...
          <li className="cart-nav onhover-dropdown">
            ...
            >
              ...
              <li>
                <div className="media">
                  <img
                    className="img-fluid rounded-circle me-3 img-60"
                  ...
                  <div className="close-circle">
                    <a href="#javascript" className="bg-danger">
                      <X />
                    </a>
                  </div>
                </div>
              ...
              <li className="total">
                <h6 className="mb-0 mt-0">
                  {OrderTotal} :{" "}
                  <span className="f-right f-14">{"$598.00"}</span>
                </h6>
              </li>
          ...
          <li className="profile-nav onhover-dropdown p-0">
            ...
            <ul className="profile-dropdown onhover-show-div ">
              ...
              <li
                onClick={() =>
                  UserMenuRedirect(
                    `${process.env.PUBLIC_URL}/app/users/userProfile/${layout}`
                  )
                }
              >
                <User />
              ...
              <li
                onClick={() =>
                  UserMenuRedirect(
                    `${process.env.PUBLIC_URL}/app/email-app/${layout}`
                  )
                }
              >
                <Mail />
              ...
              <li
                onClick={() =>
                  UserMenuRedirect(
                    `${process.env.PUBLIC_URL}/app/todo-app/todo/${layout}`
                  )
                }
              >
                <FileText />
